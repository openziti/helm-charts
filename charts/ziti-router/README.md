...
![Version: 4.0.0-pre1](https://img.shields.io/badge/Version-4.0.0--pre1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.8.0-pre5](https://img.shields.io/badge/AppVersion-1.8.0--pre5-informational?style=flat-square)

Host an OpenZiti router in Kubernetes

> **Note:** As of router chart v4, the chart major version must match for controller and router, so router v4 requires controller v4.
