...
![Version: 3.1.0-pre1](https://img.shields.io/badge/Version-3.1.0--pre1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.0-pre1](https://img.shields.io/badge/AppVersion-2.0.0--pre1-informational?style=flat-square)

Host an OpenZiti router in Kubernetes

> **Note:** Router chart v3 requires controller chart v3. The underlying Ziti v2 routers only work with Ziti v2 controllers, but v2 controllers remain compatible with older routers. This means you should **upgrade the controller chart first**, then upgrade router charts individually. Older routers will continue to operate normally with the upgraded controller during the transition.
...
| ctrl.listeners | list | `[]` | optional ctrl channel listeners for controller-to-router connections |
